...
public class FrmJuego extends JFrame {
    ...
    private boolean repartirPresionado = false;
    ...
    public FrmJuego() {
        ...
        btnRepartir.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                repartirPresionado = true; // marcar que sya se presiono
        ...
        btnVerificar.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent evt) {
                if (!repartirPresionado){ //verificar antes de repartir
                    JOptionPane.showMessageDialog(null, "¡Debes presionar 'Repartir' antes de verificar!" ,
    ...
    private void btnRepartirClick(ActionEvent evt) {
        ...
        //Mensaje de repartición
        JOptionPane.showMessageDialog(null, "Cartas repartidas con éxito!", 
            "Repartir", JOptionPane.INFORMATION_MESSAGE);
